$(document).ready(function () {
   ...
   // -----------------Local storage functions for searched cities-----------------
   ...
   // -----------------Functions to build the URL for the OpenWeather API call---------
    ...
    // -----Function to color the UV Index : https://www.epa.gov/sunsafety/uv-index-scale-0----
    ...
    function searchWeather(queryURL) {
        ...
        $.ajax({
            ...
            //------------OpenWeather API OneCall with lat and lon to get the UV index and 5 day forecast----
